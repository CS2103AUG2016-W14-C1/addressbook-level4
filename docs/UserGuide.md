...
##### Formats:<br><br>
- `view DATE_TIME [END_DATE_TIME]`<br>
...
### <br>4.3 List all Activities : **`list`**
Displays all activities in Remindaroo

##### Format:
- `list`

### <br>4.4 Clear all Activities : **`clear`**
Clear all activities in Remindaroo

##### Format:
- `clear`

### <br>4.5 Delete Activity : **`delete`**
...
### <br>4.10 Undo last command : **`undo`**
...
### <br>4.11 Redo last command: **`redo`**
...
### <br>4.12 Change Data Storage Location : **`store`**
...
### <br>4.14 Exit Remindaroo : **`exit`**
Exits the program

##### Format:<br><br>
- `exit`

### <br>4.15 Saving the data
